...
@component('mail::button', ['url' => 'http://himalayansolution.com/dashboard/my-account/orders' ,'color' => 'red'])
   View Your Order
@endcomponent
<div style="display: inline-block"> Or <a href="http://himalayansolution.com/">Visit Our Store</a></div>

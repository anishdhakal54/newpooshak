        ...
        <div class="col-lg-6 col-md-6 col-12">
          <div class="row">
            ...
            <div class="col-md-9" id="gallery_01">
              ...
              <img class="zoom_01 big_img" src="{{$image->singleUrl}}" style="width: 100%"
          ...
          <div class="row">
            <div class="col-md-12" style="    text-align: end;
                                margin-top: 21px;">
              @if(isset($product->size_chart->v1)|| isset($product->size_chart->w1)
||isset($product->size_chart->x1)|| isset($product->size_chart->y1)||
isset($product->size_chart->z1))
                <a href="javascript:void(0);" class="product-wish" data-toggle="modal"
      ...
      <div class="third" style="margin-bottom: 10px">
        @unless($product->disable_price)
          <div class="product-price-box">
            ...
            @else
              <h2>Best
                Price: {{trans('app.money_symbol')}} {{ $product->getRegularPriceAttribute() }} </h2>
            @endif
          </div>
        @endunless
    ...
    <div class="description-review-wrapper">
      <div class="description-review-topbar nav">
        ...
        @if($product->specifications->count() > 0) <a data-toggle="tab" class="active" href="#des-details2">Product
          Details</a>@endif
        <a @if($product->specifications->count() == 0) class="active" @endif data-toggle="tab"
           href="#des-details1">Description</a>

                            ...
                            <form action="" wire:submit.prevent="handleCheckout">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="col-sm-6 col-lg-12">
                                                    ...
                                                    <select class="form-control checkselect" wire:model="zone"  id="zone" name="zone">
                                ...
                                {{ $errors->first('zone') }}
                                                ...
                                                <div class="col-sm-6 col-lg-12">
                                                    ...
                                                    <select class="form-control checkselect" wire:model="district"  id="district"
                                                            name="district"
                                                            disabled>
                                ...
                                {{ $errors->first('district') }}
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <select class="form-control checkselect" wire:model="area" id="area" name="area"
                                                            disabled>
                                ...
                                {{ $errors->first('address') }}
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                    <input type="hidden" wire:model="lon"  class="form-control" name="lat" id="lat" size=12
                           value="">
                    <input type="hidden" wire:model="lat" class="form-control" name="lon" id="lon" size=12
                           value="">
                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" wire:click="handleCheckout" class="btn btn-default">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>

...
@section('content')
        ...
        @if($slideshows->isNotEmpty())
          <div class="slider-area">
            <div class="owl-carousel owl-theme"
                 data-plugin-options="{'items':1, 'loop': true,'autoplay':true,'autoplayTimeout':6000}">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="bar-textarea">
            <a href="#" data-toggle="modal" data-target="#requestModal" style="text-decoration:none"><h3>
                Requst New Product</h3></a>
          </div>
        </div>
  ...
  <div id="requestModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <h1 style="text-align: center;color: white;background-color: #ee3d43;margin-top: -20px;padding-top: 10px;padding-bottom: 10px">
          <strong>Request New Product</strong></h1>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" value="" data-msg-required="Please enter your name."
                         maxlength="100" class="form-control" name="name" id="name1" required
                         autofocus>
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" value=""
                         data-msg-required="Please enter the application of product."
  ...
  <section
      ...
      data-image-src="{{url('storage') . '/'. 'background/background.jpeg' }} ">
    <div class="container">
      <div class="row">
              ...
              <div>
                ...
                <div class="col-md-12">
                  <div class="testimonial testimonial-style-2 testimonial-with-quotes mb-none">
                    <p style="color: #c1bdbd;font-size: 30px;font-family: museo-slab;/* height: 25px; */padding-bottom: 0px;margin-bottom: 0;">
                      <strong>What Our Customers Say </strong></p>

                    <div class="testimonial-author">

                      <img
                          src="{{ null === $testimonial->getImage()  ? $testimonial->getDefaultImage('uploads/avatar.jpg')->url : $testimonial->getImage()->smallUrl }}"

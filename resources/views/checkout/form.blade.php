    ...
    <div class="form-col">
        ...
        <table class="table table-striped mb-none">
            <table class="table table-striped mb-none">
                ...
                @endphp
                {{trans('app.money_symbol')}}  {{ $subTotal }}
                {{trans('app.money_symbol')}}  {{ number_format($tax, 2) }}
                {{trans('app.money_symbol')}}  {{ number_format($grandTotal, 2) }}
                <tr>
                    <td class="text-right" colspan="2">Subtotal</td>
                    <td class="text-right">{{trans('app.money_symbol')}}  {{ $subTotal }}</td>
                </tr>
                <tr>

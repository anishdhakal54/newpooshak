<div class="col-md-12">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            @if(isset($products))
                <a href="{{ route('dashboard.order.invoice', $order->id) }}" class="btn btn-default pull-right"
                   title="Generate a pdf invoice" target="_blank">
...
<style>
    .view input, .tax-percentage input {
        border: unset;
        pointer-events: none;
    }
</style>

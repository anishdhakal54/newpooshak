<div class="tab-pane active" id="general">
    <div class="form-group{{ $errors->has('ribbon_text') ? ' has-error' : '' }}">
        <label for="ribbon_text" class="col-sm-2 control-label">Ribbon Text *</label>
        <div class="col-sm-10">
            <input type="text" name="ribbon_text" class="form-control" id="ribbon_text"
    ...
    <div class="form-group{{ $errors->has('footer-logo') ? ' has-error' : '' }}">
        <label for="footer-logo" class="col-sm-2 control-label">Site Favicon</label>
        <div class="col-sm-10">
            <input type="file" name="footer-logo" id="footer-logo" class="form-control">
            @if ($errors->has('footer-logo'))
                <span class="help-block">
                    {{ $errors->first('footer-logo') }}
                </span>
            @endif

            @if(getConfiguration('footer-logo'))
                <div class="mt-15 half-width">
                    <img src="{{ url('storage') . '/' . getConfiguration('footer-logo') }}"
                         class="thumbnail img-responsive">
                </div>
            @endif
        </div>

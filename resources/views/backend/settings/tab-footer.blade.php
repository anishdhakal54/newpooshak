<div class="tab-pane" id="footer">
    ...
    <div class="form-group{{ $errors->has('footer_text') ? ' has-error' : '' }}">
        <label for="footer_text" class="col-sm-2 control-label">Footer Text</label>
        <div class="col-sm-10">
            <input type="text" name="footer_text" class="form-control" id="footer_text"
                   value="{{ getConfiguration('footer_text') }}">
    ...
    <div class="form-group{{ $errors->has('newsletter_text') ? ' has-error' : '' }}">
        <label for="newsletter_text" class="col-sm-2 control-label">Newsletter Text</label>
        <div class="col-sm-10">
            <input type="text" name="newsletter_text" class="form-control" id="newsletter_text"
                   value="{{ getConfiguration('newsletter_text') }}">

    ...
    <div class="box box-default">
        <div class="box-body">
            ...
            <div class="form-group @if ($errors->has('gallery_name')) has-error @endif">
                {!! Form::label('gallery_name','Photo Title *', ['class' => 'control-label']) !!}
    ...
    <div class="box box-default">
        <div class="box-body">
            ...
            <div class="form-group @if ($errors->has('featured_image')) has-error @endif">
                ...
                @if(isset($gallery) && null !== $gallery->getImage())
                    <div class="mt-15">
                        <img src="{{ $gallery->getImage()->url }}" class="thumbnail img-responsive mb-none">
                    </div>
                @endif

...
class CheckoutController extends Controller
{
  ...
  public function upload_embroidery(Request $request)
  {
    if ($request->hasFile('file') && $request->file('file')->isValid()) {
      ...
      $destinationPath = 'uploads/embroidery/';
    ...
    return response()->json([
      'error' => "Sorry file cannot upload",
    ]);
    /* if (isset($_FILES['file']) and !$_FILES['file']['error']) {
       $fname = "11" . ".jpg";

       move_uploaded_file($_FILES['file']['tmp_name'], "uploads/embroidery/" . $fname);
     }*/
  }
  ...
  {
    $id = $request->zone;
    return view('checkout.zone', compact('id'));
  }
}

$(function () {
  var i = $("#contact-form"), s = $(".form-messege");
  $(i).submit(function (t) {
    t.preventDefault();
    var e = $(i).serialize();
  ...
  return n.prototype._init = function () {
    ...
    var i, s, n = this.$target.offset(), o = f - n.top, a = p - n.left, r = Math.ceil(o * u), l = Math.ceil(a * d);
  ...
  var s, n, k, x, a, r, l, h, c, T, u, p = 0, f = Array.prototype.slice;
  ...
  C.cleanData = (u = C.cleanData, function (t) {
    ...
    }), n.prototype = C.widget.extend(o, {widgetEventPrefix: s && o.widgetEventPrefix || t}, a, {
      constructor: n,
      namespace: r,
      widgetName: t,
      widgetFullName: l
    ...
    for (var e, i, s = f.call(arguments, 1), n = 0, o = s.length; n < o; n++) for (e in s[n]) i = s[n][e], s[n].hasOwnProperty(e) && void 0 !== i && (t[e] = C.isPlainObject(i) ? C.isPlainObject(t[e]) ? C.widget.extend({}, t[e], i) : C.widget.extend({}, i) : i);
    return t
    ...
    _on: function (a, r, t) {
      ...
      "boolean" != typeof a && (t = r, r = a, a = !1), t ? (r = l = C(r), this.bindings = this.bindings.add(r)) : (t = r, r = this.element, l = this.widget()), C.each(t, function (t, e) {
        ...
        var s = t.match(/^([\w:-]*)\s*(.*)$/), n = s[1] + h.eventNamespace, o = s[2];
    ...
    C.Widget.prototype["_" + o] = function (e, t, i) {
      ...
      "number" == typeof (t = t || {}) && (t = {duration: t}), s = !C.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && C.effects && C.effects.effect[n] ? e[o](t) : n !== o && e[n] ? e[n](t.duration, t.easing, i) : e.queue(function (t) {
    ...
    scrollbarWidth: function () {
      ...
      var e = C(t || window), i = C.isWindow(e[0]), s = !!e[0] && 9 === e[0].nodeType;
      return {
        element: e,
        isWindow: i,
        isDocument: s,
        offset: !i && !s ? C(t).offset() : {left: 0, top: 0},
    ...
    d = C.extend({}, d);
    var u, p, f, m, g, t, e, v = C(d.of), _ = C.position.getWithinInfo(d.within), b = C.position.getScrollInfo(_),
      y = (d.collision || "flip").split(" "), w = {}, i = 9 === (e = (t = v)[0]).nodeType ? {
        width: t.width(),
        height: t.height(),
        offset: {top: 0, left: 0}
      } : C.isWindow(e) ? {
    ...
    return v[0].preventDefault && (d.at = "left top"), p = i.width, f = i.height, m = i.offset, g = C.extend({}, m), C.each(["my", "at"], function () {
      ...
      var i, t, a = C(this), r = a.outerWidth(), l = a.outerHeight(), e = D(this, "marginLeft"),
        s = D(this, "marginTop"), n = r + e + D(this, "marginRight") + b.width,
        o = l + s + D(this, "marginBottom") + b.height, h = C.extend({}, g),
    ...
    fit: {
      left: function (t, e) {
        var i, s = e.within, n = s.isWindow ? s.scrollLeft : s.offset.left, o = s.width,
          a = t.left - e.collisionPosition.marginLeft, r = n - a, l = a + e.collisionWidth - o - n;
        ...
        var i, s = e.within, n = s.isWindow ? s.scrollTop : s.offset.top, o = e.within.height,
          a = t.top - e.collisionPosition.marginTop, r = n - a, l = a + e.collisionHeight - o - n;
      ...
      left: function (t, e) {
        var i, s, n = e.within, o = n.offset.left + n.scrollLeft, a = n.width,
          r = n.isWindow ? n.scrollLeft : n.offset.left, l = t.left - e.collisionPosition.marginLeft, h = l - r,
          c = l + e.collisionWidth - a - r,
          d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0,
          u = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, p = -2 * e.offset[0];
        ...
        var i, s, n = e.within, o = n.offset.top + n.scrollTop, a = n.height,
          r = n.isWindow ? n.scrollTop : n.offset.top, l = t.top - e.collisionPosition.marginTop, h = l - r,
          c = l + e.collisionHeight - a - r,
          d = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0,
          u = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, p = -2 * e.offset[1];
  ...
  var m, g, v, _, b, y, w, I, P, M, O, z, E, H, A, N, $, W, L, F, R, B = "ui-effects-", j = "ui-effects-style",
    Y = "ui-effects-animated", q = C;

  function U(t, e, i, s) {
    return C.isPlainObject(t) && (t = (e = t).effect), t = {effect: t}, null == e && (e = {}), C.isFunction(e) && (s = e, i = null, e = {}), "number" != typeof e && !C.fx.speeds[e] || (s = i, i = e, e = {}), C.isFunction(i) && (s = i, i = null), e && C.extend(t, e), i = i || e.duration, t.duration = C.fx.off ? 0 : "number" == typeof i ? i : i in C.fx.speeds ? C.fx.speeds[i] : C.fx.speeds._default, t.complete = s || e.complete, t
  }
  ...
  C.effects = {effect: {}}, H = /^([\-+])=\s*(\d+\.?\d*)/, A = [{
    ...
    parse: function (n, t, e, i) {
      ...
      var o = this, s = O.type(n), a = this._rgba = [];
      ...
      var e = (h = N(t))._space(), i = $[e], s = 0 === this.alpha() ? N("transparent") : this,
        r = s[i.cache] || i.to(s._rgba), l = r.slice(), h = h[i.cache];
      return R(i.props, function (t, e) {
        var i = e.idx, s = r[i], n = h[i], o = W[e.type] || {};
      ...
      var t = "rgba(", e = O.map(this._rgba, function (t, e) {
        return null == t ? 2 < e ? 1 : 0 : t
      });
      return 1 === e[3] && (e.pop(), t = "rgb("), t + e.join() + ")"
    }, toHslaString: function () {
      var t = "hsla(", e = O.map(this.hsla(), function (t, e) {
    ...
    var i = t.props, a = t.cache, r = t.to, h = t.from;
    N.fn[l] = function (t) {
      if (r && !this[a] && (this[a] = r(this._rgba)), t === z) return this[a].slice();
      var e, s = O.type(t), n = "array" === s || "object" === s ? t : arguments, o = this[a].slice();
      ...
      N.fn[a] || (N.fn[a] = function (t) {
        var e, i = O.type(t), s = "alpha" === a ? this._hsla ? "hsla" : "rgba" : l, n = this[s](), o = n[r.idx];
    ...
    return this.queue(function () {
      var i = C(this), t = i.attr("class") || "", e = (e = o.children ? i.find("*").addBack() : i).map(function () {
      ...
      s(), e = e.map(function () {
        ...
        var t = this, e = C.Deferred(), i = C.extend({}, o, {
    ...
    save: function (t, e) {
      ...
      return i.wrap(t), i[0] !== n && !C.contains(i[0], n) || C(n).trigger("focus"), t = i.parent(), "static" === i.css("position") ? (t.css({position: "relative"}), i.css({position: "relative"})) : (C.extend(s, {
    ...
    effect: function () {
      ...
      function e(t) {
        var e = C(this), i = C.effects.mode(e, l) || o;
        e.data(Y, !0), h.push(i), o && ("show" === i || i === o && "hide" === i) && e.show(), o && "none" === i || C.effects.saveStyle(e), C.isFunction(t) && t()
      }

      var s = U.apply(this, arguments), n = C.effects.effect[s.effect], o = n.mode, i = s.queue, a = i || "fx",
      ...
      var i = C(this), s = C(t.to), n = "fixed" === s.css("position"), o = C("body"), a = n ? o.scrollTop() : 0,
        r = n ? o.scrollLeft() : 0, l = s.offset(),
        h = {top: l.top - a, left: l.left - r, height: s.innerHeight(), width: s.innerWidth()}, c = i.offset(),
  ...
  C.effects.define("blind", "hide", function (t, e) {
    var i = {
        ...
        right: ["left", "right"]
      }, s = C(this), n = t.direction || "up", o = s.cssClip(), a = {clip: C.extend({}, o)},
    ...
    var i, s, n, o = C(this), a = t.mode, r = "hide" === a, l = "show" === a, h = t.direction || "up", c = t.distance,
      d = t.times || 5, u = 2 * d + (l || r ? 1 : 0), p = t.duration / u, f = t.easing,
      m = "up" === h || "down" === h ? "top" : "left", g = "up" === h || "left" === h, v = 0, _ = o.queue().length;
    for (C.effects.createPlaceholder(o), n = o.css(m), c = c || o["top" == m ? "outerHeight" : "outerWidth"]() / 3, l && ((s = {opacity: 1})[m] = n, o.css("opacity", 0).css(m, g ? 2 * -c : 2 * c).animate(s, p, f)), r && (c /= Math.pow(2, d - 1)), (s = {})[m] = n; v < d; v++) (i = {})[m] = (g ? "-=" : "+=") + c, o.animate(i, p, f).animate(s, p, f), c = r ? 2 * c : c / 2;
    r && ((i = {opacity: 0})[m] = (g ? "-=" : "+=") + c, o.animate(i, p, f)), o.queue(e), C.effects.unshift(o, _, 1 + u)
  }), C.effects.define("clip", "hide", function (t, e) {
    var i = {}, s = C(this), n = t.direction || "vertical", o = "both" === n, a = o || "horizontal" === n,
    ...
    var i, s = C(this), n = "show" === t.mode, o = t.direction || "left",
    ...
    for (var s, n, o, a, r, l = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, h = l, c = C(this), d = "show" === t.mode, u = c.show().css("visibility", "hidden").offset(), p = Math.ceil(c.outerWidth() / h), f = Math.ceil(c.outerHeight() / l), m = [], g = 0; g < l; g++) for (o = u.top + g * f, r = g - (l - 1) / 2, s = 0; s < h; s++) n = u.left + s * p, a = s - (h - 1) / 2, c.clone().appendTo("body").wrap("<div></div>").css({
      position: "absolute",
      visibility: "visible",
      left: -s * p,
      top: -g * f
    ...
    var i = C(this), s = e.mode, n = "show" === s, o = "hide" === s, a = e.size || 15, r = /([0-9]+)%/.exec(a),
      l = !!e.horizFirst ? ["right", "bottom"] : ["bottom", "right"], h = e.duration / 2,
      c = C.effects.createPlaceholder(i), d = i.cssClip(), u = {clip: C.extend({}, d)}, p = {clip: C.extend({}, d)},
      f = [d[l[0]], d[l[1]]], m = i.queue().length;
    ...
    var t, o, i, s = C(this), a = ["fontSize"],
      r = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
      l = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], h = n.mode, c = "effect" !== h,
      d = n.scale || "both", u = n.origin || ["middle", "center"], p = s.css("position"), f = s.position(),
    ...
    C.effects.createPlaceholder(s), "show" === h && (i = g, g = v, v = i), o = {
      ...
      var t = C(this), e = C.effects.scaledDimensions(t), i = {
    ...
    var i = C(this), s = t.mode,
      n = parseInt(t.percent, 10) || (0 === parseInt(t.percent, 10) || "effect" !== s ? 0 : 100), o = C.extend(!0, {
    ...
    var i = C(this), s = t.mode, n = "show" === s, o = n || "hide" === s, a = 2 * (t.times || 5) + (o ? 1 : 0),
      r = t.duration / a, l = 0, h = 1, c = i.queue().length;
    ...
    var i = 1, s = C(this), n = t.direction || "left", o = t.distance || 20, a = t.times || 3, r = 2 * a + 1,
      l = Math.round(t.duration / r), h = "up" === n || "down" === n ? "top" : "left", c = "up" === n || "left" === n,
      d = {}, u = {}, p = {}, f = s.queue().length;
    ...
    var i, s, n = C(this),
      ...
      h = "up" === r || "left" === r, c = t.distance || n["top" == l ? "outerHeight" : "outerWidth"](!0), d = {};
    ...
    tabbable: function (t) {
      var e = C.attr(t, "tabindex"), i = null != e;
    ...
    _refresh: function () {
      ...
      this.active = this._findActive(t.active), this._addClass(this.active, "ui-accordion-header-active", "ui-state-active")._removeClass(this.active, "ui-accordion-header-collapsed"), this._addClass(this.active.next(), "ui-accordion-content-active"), this.active.next().show(), this.headers.attr("role", "tab").each(function () {
        var t = C(this), e = t.uniqueId().attr("id"), i = t.next(), s = i.uniqueId().attr("id");
    ...
    _eventHandler: function (t) {
      var e, i, s = this.options, n = this.active, o = C(t.currentTarget), a = o[0] === n[0], r = a && s.collapsible,
        l = r ? C() : o.next(), h = n.next(), c = {oldHeader: n, oldPanel: h, newHeader: r ? C() : o, newPanel: l};
    ...
    _animate: function (t, i, e) {
      ...
      var n, o, a, r = this, l = 0, h = t.css("box-sizing"), c = t.length && (!i.length || t.index() < i.index()),
        d = this.options.animate || {}, u = c && d.down || d;
      return "number" == typeof u && (a = u), "string" == typeof u && (o = u), o = o || u.easing || d.easing, a = a || u.duration || d.duration, i.length ? t.length ? (n = t.show().outerHeight(), i.animate(this.hideProps, {
        ...
        duration: a, easing: o, complete: s, step: function (t, e) {
    ...
    _create: function () {
      this.activeMenu = this.element, this.mouseHandled = !1, this.element.uniqueId().attr({
        ...
        "mousedown .ui-menu-item": function (t) {
          ...
          var e = C(t.target), i = C(C.ui.safeActiveElement(this.document[0]));
    ...
    refresh: function () {
      ...
      this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length), e = a.filter(":not(.ui-menu)").hide().attr({
        ...
        var t = C(this), e = t.prev(), i = C("<span>").data("ui-menu-submenu-caret", !0);
    ...
    _create: function () {
      ...
      this.isMultiLine = e || !o && this._isContentEditable(this.element), this.valueMethod = this.element[e || o ? "val" : "text"], this.isNewMenu = !0, this._addClass("ui-autocomplete-input"), this.element.attr("autocomplete", "off"), this._on(this.element, {
        ...
        mousedown: function (t) {
          ...
          })) : (s = e.item.data("ui-autocomplete-item"), !1 !== this._trigger("focus", t, {item: s}) && t.originalEvent && /^key/.test(t.originalEvent.type) && this._value(s.value), void ((i = e.item.attr("aria-label") || s.value) && C.trim(i).length && (this.liveRegion.children().hide(), C("<div>").text(i).appendTo(this.liveRegion))))
    ...
    _normalize: function (t) {
      return t.length && t[0].label && t[0].value ? t : C.map(t, function (t) {
        return "string" == typeof t ? {label: t, value: t} : C.extend({}, t, {
    ...
    _suggest: function (t) {
      ...
      this._renderMenu(e, t), this.isNewMenu = !0, this.menu.refresh(), e.show(), this._resizeMenu(), e.position(C.extend({of: this.element}, this.options.position)), this.options.autoFocus && this.menu.next(), this._on(this.document, {mousedown: "_closeOnClickOutside"})
    },
  ...
  C.widget("ui.controlgroup", {
    ...
    _initWidgets: function () {
      ...
      C.each(this.options.items, function (n, t) {
        ...
        }), a._addClass(e, null, "ui-widget ui-widget-content ui-state-default"), void (r = r.concat(e.get()))) : void (C.fn[n] && (o = a["_" + n + "Options"] ? a["_" + n + "Options"]("middle") : {classes: {}}, a.element.find(t).each(function () {
          var t, e = C(this), i = e[n]("instance"), s = C.widget.extend({}, o);
    ...
    _resolveClassesValues: function (i, s) {
      ...
      return C.each(i, function (t) {
        var e = s.options.classes[t] || "", e = C.trim(e.replace(st, ""));
    ...
    _getRadioGroup: function () {
      var t = this.element[0].name, e = "input[name='" + C.ui.escapeSelector(t) + "']";
    ...
    return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? et.apply(this, arguments) : (C.ui.checkboxradio || C.error("Checkboxradio widget missing"), 0 === arguments.length ? this.checkboxradio({icon: !1}) : this.checkboxradio.apply(this, arguments))
  ...
  }), C.ui.button, C.extend(C.ui, {datepicker: {version: "1.12.1"}}), C.extend(t.prototype, {
    ...
    _destroyDatepicker: function (t) {
      var e, i = C(t), s = C.data(t, "datepicker");
    ...
    _enableDatepicker: function (e) {
      var t, i, s = C(e), n = C.data(e, "datepicker");
    ...
    _doKeyDown: function (t) {
      var e, i, s, n = C.datepicker._getInst(t.target), o = !0, a = n.dpDiv.is(".ui-datepicker-rtl");
    ...
    _gotoToday: function (t) {
      var e, i = C(t), s = this._getInst(i[0]);
    ...
    _selectDate: function (t, e) {
      var i, s = C(t), n = this._getInst(s[0]);
    ...
    parseDate: function (i, o, t) {
      ...
      function e(t) {
        var e = a(t), i = "@" === t ? 14 : "!" === t ? 20 : "y" === t && e ? 4 : "o" === t ? 3 : 2,
          s = RegExp("^\\d{" + ("y" === t ? i : 1) + "," + i + "}"), n = o.substring(c).match(s);
        if (!n) throw"Missing number at position " + c;
        return c += n[0].length, parseInt(n[0], 10)
      }

      function s(t, e, i) {
        var s = -1, n = C.map(a(t) ? i : e, function (t, e) {
          return [[e, t]]
        }).sort(function (t, e) {
      ...
      if (-1 === v ? v = (new Date).getFullYear() : v < 100 && (v += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (v <= u ? 0 : -100)), -1 < y) for (_ = 1, b = y; !(b <= (r = this._getDaysInMonth(v, _ - 1)));) _++, b -= r;
    ...
    formatDate: function (i, t, e) {
      ...
      var a, r = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
        ...
        c = (e ? e.monthNames : null) || this._defaults.monthNames, d = "", u = !1;
      if (t) for (a = 0; i.length > a; a++) if (u) "'" !== i.charAt(a) || n("'") ? d += i.charAt(a) : u = !1; else switch (i.charAt(a)) {
        case"d":
          d += s("d", t.getDate(), 2);
          break;
        case"D":
    ...
    _possibleChars: function (i) {
      ...
      for (var e = "", s = !1, n = 0; i.length > n; n++) if (s) "'" !== i.charAt(n) || t("'") ? e += i.charAt(n) : s = !1; else switch (i.charAt(n)) {
        case"d":
        case"m":
        case"y":
        case"@":
    ...
    _generateHTML: function (t) {
      var e, i, s, n, o, a, r, l, h, c, d, u, p, f, m, g, v, _, b, y, w, k, C, x, T, S, D, I, P, M, O, z, E, H, A, N, $,
        W, L, F = new Date, R = this._daylightSavingAdjust(new Date(F.getFullYear(), F.getMonth(), F.getDate())),
        B = this._get(t, "isRTL"), j = this._get(t, "showButtonPanel"), Y = this._get(t, "hideIfNoPrevNext"),
  ...
  C(document).on("mouseup", function () {
    ...
    _createHelper: function (t) {
      var e = this.options, i = C.isFunction(e.helper),
    ...
    start: function (t, e, i) {
      ...
      }).left)), !i.snapElements[_].snapping && (s || n || o || a || d) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, C.extend(i._uiHash(), {snapItem: i.snapElements[_].item})), i.snapElements[_].snapping = s || n || o || a || d)
    }
  }), C.ui.plugin.add("draggable", "stack", {
    start: function (t, e, i) {
      var s, n = i.options, o = C.makeArray(C(n.stack)).sort(function (t, e) {
    ...
    _setupHandles: function () {
      ...
      if (this.handles = o.handles || (C(".ui-resizable-handle", this.element).length ? {
        ...
        ne: ".ui-resizable-ne",
        nw: ".ui-resizable-nw"
      } : "e,s,se"), this._handles = C(), this.handles.constructor === String) for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), i = this.handles.split(","), this.handles = {}, e = 0; i.length > e; e++) s = "ui-resizable-" + (t = C.trim(i[e])), n = C("<div>"), this._addClass(n, "ui-resizable-handle " + s), n.css({zIndex: o.zIndex}), this.handles[t] = ".ui-resizable-" + t, this.element.append(n);
      this._renderAxis = function (t) {
        var e, i, s, n;
        for (e in t = t || this.element, this.handles) this.handles[e].constructor === String ? this.handles[e] = this.element.children(this.handles[e]).first().show() : (this.handles[e].jquery || this.handles[e].nodeType) && (this.handles[e] = C(this.handles[e]), this._on(this.handles[e], {mousedown: a._mouseDown})), this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && (i = C(this.handles[e], this.element), n = /sw|ne|nw|se|n|s/.test(e) ? i.outerHeight() : i.outerWidth(), s = ["padding", /ne|nw|n/.test(e) ? "Top" : /se|sw|s/.test(e) ? "Bottom" : /^e$/.test(e) ? "Right" : "Left"].join(""), t.css(s, n), this._proportionallyResize()), this._handles = this._handles.add(this.handles[e])
    ...
    _mouseDrag: function (t) {
      var e, i, s = this.originalMousePosition, n = this.axis, o = t.pageX - s.left || 0, a = t.pageY - s.top || 0,
        r = this._change[n];
    ...
    stop: function (e) {
      var i = C(this).resizable("instance"), t = i.options, s = i._proportionallyResizeElements,
        n = s.length && /textarea/i.test(s[0].nodeName), o = n && i._hasScroll(s[0], "left") ? 0 : i.sizeDiff.height,
        a = n ? 0 : i.sizeDiff.width, r = {width: i.size.width - a, height: i.size.height - o},
    ...
    start: function () {
      var i, s, t, e, n, o, a, r = C(this).resizable("instance"), l = r.options, h = r.element, c = l.containment,
      ...
      var e, i, s, n, o = C(this).resizable("instance"), a = o.options, r = o.containerOffset, l = o.position,
        h = o._aspectRatio || t.shiftKey, c = {top: 0, left: 0}, d = o.containerElement, u = !0;
      ...
      var t = C(this).resizable("instance"), e = t.options, i = t.containerOffset, s = t.containerPosition,
        n = t.containerElement, o = C(t.helper), a = o.offset(), r = o.outerWidth() - t.sizeDiff.width,
    ...
    start: function () {
      ...
      var e = C(this).resizable("instance"), s = e.options, n = e.originalSize, o = e.originalPosition, a = {
      ...
      C(s.alsoResize).each(function () {
        var t = C(this), s = C(this).data("ui-resizable-alsoresize"), n = {},
    ...
    start: function () {
      var t = C(this).resizable("instance"), e = t.size;
    ...
    resize: function () {
      var t, e = C(this).resizable("instance"), i = e.options, s = e.size, n = e.originalSize, o = e.originalPosition,
        a = e.axis, r = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, l = r[0] || 1, h = r[1] || 1,
        c = Math.round((s.width - n.width) / l) * l, d = Math.round((s.height - n.height) / h) * h, u = n.width + c,
        p = n.height + d, f = i.maxWidth && u > i.maxWidth, m = i.maxHeight && p > i.maxHeight,
        g = i.minWidth && i.minWidth > u, v = i.minHeight && i.minHeight > p;
    ...
    _createButtons: function () {
      ...
      return this.uiDialogButtonPane.remove(), this.uiButtonSet.empty(), C.isEmptyObject(t) || C.isArray(t) && !t.length ? void this._removeClass(this.uiDialog, "ui-dialog-buttons") : (C.each(t, function (t, e) {
        ...
        e = C.isFunction(e) ? {
          click: e,
          text: t
        } : e, e = C.extend({type: "button"}, e), i = e.click, s = {
          icon: e.icon,
    ...
    _makeResizable: function () {
      ...
      var a = this, r = this.options, t = r.resizable, e = this.uiDialog.css("position"),
    ...
    _untrackInstance: function () {
      var t = this._trackingInstances(), e = C.inArray(this, t);
      -1 !== e && t.splice(e, 1)
    },
    ...
    _drop: function (e, t) {
      var i = t || C.ui.ddmanager.current, s = !1;
      return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
        var t = C(this).droppable("instance");
        return t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && at(i, C.extend(t, {offset: t.element.offset()}), t.options.tolerance, e) ? !(s = !0) : void 0
  ...
  !(C.ui.ddmanager = {
    current: null, droppables: {default: []}, prepareOffsets: function (t, e) {
      var i, s, n = C.ui.ddmanager.droppables[t.options.scope] || [], o = e ? e.type : null,
    ...
    _create: function () {
      ...
      this._addClass("ui-selectable"), this.dragged = !1, this.refresh = function () {
        s.elementPos = C(s.element[0]).offset(), s.selectees = C(s.options.filter, s.element[0]), s._addClass(s.selectees, "ui-selectee"), s.selectees.each(function () {
          var t = C(this), e = t.offset(), i = {left: e.left - s.elementPos.left, top: e.top - s.elementPos.top};
    ...
    _mouseDrag: function (s) {
      if (this.dragged = !0, !this.options.disabled) {
        ...
        return l < a && (t = l, l = a, a = t), h < r && (t = h, h = r, r = t), this.helper.css({
          ...
          var t = C.data(this, "selectable-item"), e = !1, i = {};
    ...
    _renderMenu: function (s, t) {
      ...
      C.each(t, function (t, e) {
        var i;
        e.optgroup !== o && (i = C("<li>", {text: e.optgroup}), n._addClass(i, "ui-selectmenu-optgroup", "ui-menu-divider" + (e.element.parent("optgroup").prop("disabled") ? " ui-state-disabled" : "")), i.appendTo(s), o = e.optgroup), n._renderItemData(s, e)
      })
    },
    _renderItemData: function (t, e) {
    ...
    _renderItem: function (t, e) {
      var i = C("<li>"), s = C("<div>", {title: e.element.attr("title")});
    ...
    _mouseCapture: function (t) {
      var e, i, s, n, o, a, r, l = this, h = this.options;
    ...
    _refreshValue: function () {
      ...
      this._hasMultipleValues() ? this.handles.each(function (t) {
        i = (r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, h["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", C(this).stop(1, 1)[l ? "animate" : "css"](h, a.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === t && r.range.stop(1, 1)[l ? "animate" : "css"]({left: i + "%"}, a.animate), 1 === t && r.range[l ? "animate" : "css"]({width: i - e + "%"}, {
          queue: !1,
          duration: a.animate
    ...
    _intersectsWith: function (t) {
      var e = this.positionAbs.left, i = e + this.helperProportions.width, s = this.positionAbs.top,
        ...
        h = this.offset.click.top, c = this.offset.click.left, d = "x" === this.options.axis || r < s + h && s + h < l,
        u = "y" === this.options.axis || o < e + c && e + c < a, p = d && u;
    ...
    _getItemsAsjQuery: function (t) {
      ...
      if (l && t) for (i = l.length - 1; 0 <= i; i--) for (s = (n = C(l[i], this.document[0])).length - 1; 0 <= s; s--) (o = C.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && r.push([C.isFunction(o.options.items) ? o.options.items.call(o.element) : C(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
    ...
    _refreshItems: function (t) {
      ...
      var e, i, s, n, o, a, r, l, h = this.items,
        ...
        d = this._connectWith();
      if (d && this.ready) for (e = d.length - 1; 0 <= e; e--) for (i = (s = C(d[e], this.document[0])).length - 1; 0 <= i; i--) (n = C.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && (c.push([C.isFunction(n.options.items) ? n.options.items.call(n.element[0], t, {item: this.currentItem}) : C(n.options.items, n.element), n]), this.containers.push(n));
    ...
    _createPlaceholder: function (i) {
      ...
      n.placeholder && n.placeholder.constructor !== String || (s = n.placeholder, n.placeholder = {
        element: function () {
          var t = i.currentItem[0].nodeName.toLowerCase(), e = C("<" + t + ">", i.document[0]);
    ...
    _contactContainers: function (t) {
      for (var e, i, s, n, o, a, r, l, h, c = null, d = null, u = this.containers.length - 1; 0 <= u; u--) if (!C.contains(this.currentItem[0], this.containers[u].element[0])) if (this._intersectsWith(this.containers[u].containerCache)) {
    ...
    _keydown: function (t) {
      var e = this.options, i = C.ui.keyCode;
      switch (t.keyCode) {
        case i.UP:
    ...
    _tabKeydown: function (t) {
      var e = C(C.ui.safeActiveElement(this.document[0])).closest("li"), i = this.tabs.index(e), s = !0;
    ...
    _processTabs: function () {
      ...
      this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", function (t) {
        ...
        var i, s, n, o = C(e).uniqueId().attr("id"), a = C(e).closest("li"), r = a.attr("aria-controls");
    ...
    _eventHandler: function (t) {
      var e = this.options, i = this.active, s = C(t.currentTarget).closest("li"), n = s[0] === i[0],
        o = n && e.collapsible, a = o ? C() : this._getPanelForTab(s), r = i.length ? this._getPanelForTab(i) : C(),
    ...
    _destroy: function () {
      this.xhr && this.xhr.abort(), this.tablist.removeAttr("role").off(this.eventNamespace), this.anchors.removeAttr("role tabIndex").removeUniqueId(), this.tabs.add(this.panels).each(function () {
        ...
        var t = C(this), e = t.data("ui-tabs-aria-controls");
    ...
    load: function (t, s) {
      ...
      var o = this, i = this.tabs.eq(t), e = i.find(".ui-tabs-anchor"), a = this._getPanelForTab(i),
        r = {tab: i, panel: a};
    ...
    version: "1.12.1", options: {
      ...
      var e = t.data("ui-tooltip-id"), i = (t.attr("aria-describedby") || "").split(/\s+/), s = C.inArray(e, i);
      ...
      var i = this, e = C(t ? t.target : this.element).closest(this.options.items);
      ...
      if (i) {
        ...
        e.is("[title]") && (t && "mouseover" === t.type ? e.attr("title", "") : e.removeAttr("title")), n = this._tooltip(e), o = n.tooltip, this._addDescribedBy(e, o.attr("id")), o.find(".ui-tooltip-content").html(i), this.liveRegion.children().hide(), (r = C("<div>").html(o.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"), r.removeAttr("id").find("[id]").removeAttr("id"), r.appendTo(this.liveRegion), this.options.track && t && /^mouse/.test(t.type) ? (this._on(this.document, {mousemove: s}), s(t)) : o.position(C.extend({of: e}, this.options.position)), o.hide(), this._show(o, this.options.show), this.options.track && this.options.show && this.options.show.delay && (a = this.delayedShow = setInterval(function () {
          o.is(":visible") && (s(l.of), clearInterval(a))
        }, C.fx.interval)), this._trigger("open", t, {tooltip: o})
      }
      ...
      var e, i = this, s = C(t ? t.currentTarget : this.element), n = this._find(s);
      ...
      var e = C("<div>").attr("role", "tooltip"), i = C("<div>").appendTo(e), s = e.uniqueId().attr("id");
      ...
      var n = this;
      C.each(this.tooltips, function (t, e) {
        var i = C.Event("blur"), s = e.element;
  ...
  var e = {
    ...
    margin: .5,
    image_size: 640
  }, f = {150: 0, 240: 1, 320: 2, 480: 3, 640: 4}, m = {
    "&": "&amp;",
    "<": "&lt;",
    ">": "&gt;",
    '"': "&quot;",
  ...
  p.instagramFeed = function (t) {
    ...
    return p.get(u ? d.host + "explore/tags/" + d.tag + "/" : d.host + d.username + "/", function (t) {
      ...
      if (void 0 === (t = (t = JSON.parse(t.substr(0, t.length - 1))).entry_data.ProfilePage || t.entry_data.TagPage)) console.error("Instagram Feed: It looks like YOUR network has been temporary banned because of too many requests. See https://github.com/jsanahuja/jquery.instagramFeed/issues/25"); else if (t = t[0].graphql.user || t[0].graphql.hashtag, d.get_data) d.callback(t); else {
        var e = "", i = "", s = "", n = "", o = "";
        ...
        if (d.display_profile && (a = a + "<div class='instagram_profile'" + e + "><img class='instagram_profile_image' src='" + t.profile_pic_url + "' alt='" + (u ? t.name + " tag pic" : t.username + " profile pic") + "'" + i + " />", a = u ? a + ("<p class='instagram_tag'" + s + "><a href='https://www.instagram.com/explore/tags/" + d.tag + "' rel='noopener' target='_blank'>#" + d.tag) + "</a></p>" : a + ("<p class='instagram_username'" + s + ">@" + t.full_name + " (<a href='https://www.instagram.com/" + d.username + "' rel='noopener' target='_blank'>@" + d.username) + "</a>)</p>", !u && d.display_biography && (a += "<p class='instagram_biography'" + n + ">" + t.biography + "</p>"), a += "</div>"), s = void 0 !== f[d.image_size] ? f[d.image_size] : f[640], d.display_gallery) if (void 0 !== t.is_private && !0 === t.is_private) a += "<p class='instagram_private'><strong>This profile is private</strong></p>"; else {
          for (i = (n = (t.edge_owner_to_timeline_media || t.edge_hashtag_to_media).edges).length > d.items ? d.items : n.length, a += "<div class='instagram_gallery'>", e = 0; e < i; e++) {
            ...
            switch (n[e].node.__typename) {
              case"GraphSidecar":
                var l = "sidecar", h = n[e].node.thumbnail_resources[s].src;
                break;
              case"GraphVideo":
  ...
  o.fn.niceSelect = function (t) {
    ...
    this.hide(), this.each(function () {
      ...
      var e, i, s = o(this), n = o(s.find(".focus") || s.find(".list .option.selected"));
  ...
  var d = "day", a = "hour", r = "minute", l = "second", s = {d: d, h: a, m: r, s: l}, h = {
    list: [l, r, a, d], next: function (t) {
  ...
  }, o = {second: !1, minute: !1, hour: !1, day: !1}, u = {
    init: function (t) {
      var e = c.extend({}, n, t || {});
      ...
      for (var t = c(this), e = t.data("syotimer-options"), i = p.getTimerItem(), s = c("<div/>", {class: "syotimer__head"}).html(e.headTitle), n = c("<div/>", {class: "syotimer__body"}), o = c("<div/>", {class: "syotimer__footer"}).html(e.footTitle), a = {}, r = 0; r < e.itemTypes.length; r++) {
        var l = i.clone();
      ...
      var i = new Date, s = new Date(e.year, e.month - 1, e.day, e.hour, e.minute, e.second),
        n = p.getDifferenceWithTimezone(i, s, e), o = p.getSecondsToDeadLine(n, e);
      ...
      e = e || l;
      var i, s, n, o = this, a = c(o);
      "none" === t ? setTimeout(function () {
        u._perSecondHandler.apply(o, [])
      }, 1e3) : "opacity" !== t || (i = a.data("syotimer-items")[e]) && (s = h.next(e), n = i.data("syotimer-unit-value"), c(".syotimer-cell__value", i).animate({opacity: .1}, 1e3, "linear", function () {
        u._perSecondHandler.apply(o, [])
      }), s && 0 === n && u._applyEffectSwitch.apply(o, [t, s]))
    }
  }, p = {
    getTimerItem: function () {
      var t = c("<div/>", {class: "syotimer-cell__value", text: "0"}), e = c("<div/>", {class: "syotimer-cell__unit"}),
      ...
      var i, s, n, o, a = t / 1e3, a = Math.floor(a);
      ...
      var s = e.getTime() - t.getTime(), n = 0, o = 0;
  ...
  var m, s, g, n, v, e, l = "Close", h = "BeforeClose", _ = "MarkupParse", b = "Open", y = ".mfp", w = "mfp-ready",
    i = "mfp-removing", a = "mfp-prevent-close", r = !!window.jQuery, k = c(window);
  t.prototype = {
    ...
    o();
    var e, i, s, n = c(this);
    return "string" == typeof t ? "open" === t ? (e = r ? n.data("magnificPopup") : n[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = n, e.delegate && (s = s.find(e.delegate)), s.eq(i)), m._openClick({mfpEl: s}, n, e)) : m.isOpen && m[t].apply(m, Array.prototype.slice.call(arguments, 1)) : (t = c.extend(!0, {}, t), r ? n.data("magnificPopup", t) : n[0].magnificPopup = t, m.addGroup(n, t)), n
  };
  ...
  c.magnificPopup.registerModule("zoom", {
    options: {
      ...
      initZoom: function () {
        var t, e, i, s, n, o, a = m.st.zoom, r = ".zoom";
        ...
        var e = t ? m.currItem.img : m.st.zoom.opener(m.currItem.el || m.currItem), i = e.offset(),
  ...
  n = 0, (a = function (t, e) {
    ...
    var i = {}, s = this;
    s.animateHeight(), !0 === s.options.rtl && !1 === s.options.vertical && (t = -t), !1 === s.transformsEnabled ? !1 === s.options.vertical ? s.$slideTrack.animate({left: t}, s.options.speed, s.options.easing, e) : s.$slideTrack.animate({top: t}, s.options.speed, s.options.easing, e) : !1 === s.cssTransitions ? (!0 === s.options.rtl && (s.currentLeft = -s.currentLeft), h({animStart: s.currentLeft}).animate({animStart: t}, {
    ...
    var t, e, i, s = this, n = document.createDocumentFragment(), o = s.$slider.children();
    if (1 < s.options.rows) {
    ...
    var i, s, n, o = this, a = !1, r = o.$slider.width(), l = window.innerWidth || h(window).width();
    ...
    var i, s, n = this, o = h(t.currentTarget);
    ...
    i.$slides.add(i.$slideTrack.find(".slick-cloned")).attr({
      ...
      h(this).attr({
        ...
        tabindex: -1
      }), -1 !== e && h(this).attr({"aria-describedby": "slick-slide-control" + i.instanceUid + e})
    }), i.$dots.attr("role", "tablist").find("li").each(function (t) {
      var e = n[t];
      h(this).attr({role: "presentation"}), h(this).find("button").first().attr({
        role: "tab",
    ...
    var t = this;
    !0 === t.options.dots && (h("li", t.$dots).on("click.slick", {message: "index"}, t.changeSlide), !0 === t.options.accessibility && t.$dots.on("keydown.slick", t.keyHandler)), !0 === t.options.dots && !0 === t.options.pauseOnDotsHover && h("li", t.$dots).on("mouseenter.slick", h.proxy(t.interrupt, t, !0)).on("mouseleave.slick", h.proxy(t.interrupt, t, !1))
    ...
    function t(t) {
      h("img[data-lazy]", t).each(function () {
        var t = h(this), e = h(this).attr("data-lazy"), i = h(this).attr("data-srcset"),
          s = h(this).attr("data-sizes") || o.$slider.attr("data-sizes"), n = document.createElement("img");
        n.onload = function () {
    ...
    var e, i, s, o = this;
    if (!0 === o.options.centerMode ? s = !0 === o.options.infinite ? (i = o.currentSlide + (o.options.slidesToShow / 2 + 1)) + o.options.slidesToShow + 2 : (i = Math.max(0, o.currentSlide - (o.options.slidesToShow / 2 + 1)), o.options.slidesToShow / 2 + 1 + 2 + o.currentSlide) : (i = o.options.infinite ? o.options.slidesToShow + o.currentSlide : o.currentSlide, s = Math.ceil(i + o.options.slidesToShow), !0 === o.options.fade && (0 < i && i--, s <= o.slideCount && s++)), e = o.$slider.find(".slick-slide").slice(i, s), "anticipated" === o.options.lazyLoad) for (var n = i - 1, a = s, r = o.$slider.find(".slick-slide"), l = 0; l < o.options.slidesToScroll; l++) n < 0 && (n = o.slideCount - 1), e = (e = e.add(r.eq(n))).add(r.eq(a)), n--, a++;
    ...
    t = t || 1;
    var e, i, s, n, o, a = this, r = h("img[data-lazy]", a.$slider);
    ...
    !i.options.infinite && i.currentSlide > s && (i.currentSlide = s), i.slideCount <= i.options.slidesToShow && (i.currentSlide = 0), e = i.currentSlide, i.destroy(!0), h.extend(i, i.initials, {currentSlide: e}), i.init(), t || i.changeSlide({
      data: {
        message: "index",
        index: e
      }
    ...
    var t, e, i, s = this, n = s.options.responsive || null;
    ...
    s.$slides.each(function (t, e) {
      i = s.slideWidth * t * -1, !0 === s.options.rtl ? h(e).css({
        ...
        opacity: 0
      }) : h(e).css({position: "relative", left: i, top: 0, zIndex: s.options.zIndex - 2, opacity: 0})
    ...
    var t, e = this, i = e.touchObject.startX - e.touchObject.curX, s = e.touchObject.startY - e.touchObject.curY,
      n = Math.atan2(s, i);
    ...
    var e, i, s, n, o, a = this, r = void 0 !== t.originalEvent ? t.originalEvent.touches : null;
    ...
    for (var t, e = this, i = arguments[0], s = Array.prototype.slice.call(arguments, 1), n = e.length, o = 0; o < n; o++) if ("object" == typeof i || void 0 === i ? e[o].slick = new a(e[o], i) : t = e[o].slick[i].apply(e[o].slick, s), void 0 !== t) return t;
    return e
  }
}), function (t) {
  ...
  var l, s, n, t, o = (s = {
    ...
    key: "bindEvents", value: function () {
      window.addEventListener("resize", this, {passive: !0}), window.addEventListener("scroll", this, {passive: !0}), this.sidebar.addEventListener("update" + l, this), this.options.resizeSensor && "undefined" != typeof ResizeSensor && (new ResizeSensor(this.sidebarInner, this.handleEvent), new ResizeSensor(this.container, this.handleEvent))
    }
  }, {
    ...
    key: "_getStyle", value: function (t) {
      if (void 0 !== t) {
        ...
        return e.outer = h.extend({height: "", position: ""}, e.outer), e.inner = h.extend({
          position: "relative",
          top: "",
          left: "",
          bottom: "",
  ...
  window.StickySidebar = o, "undefined" == typeof window || (n = window.$ || window.jQuery || window.Zepto) && (n.fn.stickySidebar = function (i) {
    return this.each(function () {
      var t = n(this), e = n(this).data("stickySidebar");
  ...
  c.prototype.extend = function (t, e) {
  ...
  }, h), s = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (r.notSupported = !0, r.prototype.observe = function () {
  }, r), l = this.getComputedStyle || function (i, t) {
    ...
    var i, s = t.getAttribute("data-wow-duration"), n = t.getAttribute("data-wow-delay"),
    ...
    var e = t.getAttribute("data-wow-offset") || this.config.offset,
      ...
      s = i + Math.min(this.element.clientHeight, this.util().innerHeight()) - e, n = this.offsetTop(t),
      o = n + t.clientHeight;
    return n <= s && i <= o
